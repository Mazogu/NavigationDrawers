package com.example.micha.navigationactivity.utils;

import com.example.micha.navigationactivity.R;

/**
 * Created by micha on 1/14/2018.
 */

public class Constants {
    public static class StringIDs{
        public static final int MAINID = R.string.Main;
